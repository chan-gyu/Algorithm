...
public class Solution41 {
	public String solution(String X, String Y) {
		...
		//인덱스값에 int 값을 넣어 뒤에서 부터 반복문을 돌려 값을 뽑아냄
		//숫자,자리값을 비교하지 않고 직관적으로 최대값을 뽑아낼 수 있음
	...
	다른 예시로 X = 5525이고 Y = 1255이면 X와 Y의 짝꿍은 X와 Y에서 공통으로
	나타나는 2, 5, 5로 만들 수 있는 가장 큰 정수인 552입니다
