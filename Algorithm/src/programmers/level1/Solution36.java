...
public class Solution36 {
	...
	public int solution(String[] babbling) {
		...
		for(String bab : babbling) {
			...
			for(String rBab : repeatBabList) {
				System.out.println("rBab : " + rBab);
				bab = bab.replace(rBab, "X");
				System.out.println("rbab2 : " + bab);
				System.out.println("==============");
			
			for(String oBab : originalBabList) {
				System.out.println("oBab : " + oBab);
				bab = bab.replace(oBab, "?");
				System.out.println("obab3 : " + bab);
				System.out.println("==============");
			}
			}
	...
	발음밖에 하지 못하고 연속해서 같은 발음을 하는 것을 어려워합니다. 문자열 배열 babbling이
	매개변수로 주어질 때, 머쓱이의 조카가 발음할 수 있는 단어의 개수를 return하도록 solution
	함수를 완성해주세요.
